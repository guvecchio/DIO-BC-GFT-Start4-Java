...
public class OperadoresAritmeticos {
    ...
    public static void prePos(){
        ...
        int i = ++k; // o K recebe um, para então atribuir ao i, 11.
        int j = k--; // o J recebe o K, 11, para depois retirar um de k, que volta a valer 10.
        int x = k; // o k, que voltou a valer 10;
    ...
    private static void precedencia(){
        ...
        int c = 2;
        c *= i += 5; // 2 * i; i + 5; -> 2 * i; 10(i) + 5; -> 2 * 15; -> c = 30;
